...
class DRegisterPage extends StatefulWidget {
  final VoidCallback DshowLogInPage;
  const DRegisterPage({Key? key, required this.DshowLogInPage}) : super(key: key);
