...
import 'Pforgot_password_page.dart';
...
class PLogIn extends StatefulWidget {
  final VoidCallback PshowRegisterPage;
  const PLogIn({Key? key, required this.PshowRegisterPage}) : super(key: key);
                    ...
                    */
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: widget.PshowRegisterPage,
                          child: const Text(
                            'Register now',
                            style: TextStyle(
                              color: Colors.pink,
